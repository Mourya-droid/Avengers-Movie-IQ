...
if(points >= 5){
    head_result.innerHTML = "That's nice!  You've got" + points + "out of 7 right";
    body_result.innerText = "You worked hard and it paid off! Nice figuring out these tough questions, you earned it buddy!"
}else{
